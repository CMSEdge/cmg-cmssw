...
susyJZBEdge_globalObjects.update({
            # put more here
            "met_jecUp"   : NTupleObject("met_jecUp"  , metType, help="PF E_{T}^{miss}, after type 1 corrections JEC UP"),
            "met_jecDown" : NTupleObject("met_jecDown", metType, help="PF E_{T}^{miss}, after type 1 corrections JEC DOWN")
})

## ML collections susyMultilepton_collections = susyCore_collections.copy()
## ML collections susyMultilepton_collections.update({
## ML collections             # put more here
## ML collections             "gentopquarks"    : NTupleCollection("GenTop",     genParticleType, 2, help="Generated top quarks from hard scattering (needed separately for top pt reweighting)"),
## ML collections             ##--------------------------------------------------                                                                                                                                   
## ML collections             "selectedTaus"    : NTupleCollection("TauGood",  tauTypeSusy, 8, help="Taus after the preselection"),
## ML collections             "selectedLeptons" : NTupleCollection("LepGood",  leptonTypeSusyExtra, 8, help="Leptons after the preselection"),
## ML collections             "otherLeptons"    : NTupleCollection("LepOther", leptonTypeSusyExtra, 8, help="Leptons after the preselection"),
## ML collections             ##------------------------------------------------
## ML collections             "cleanJets"       : NTupleCollection("Jet",     jetTypeSusyExtra, 15, help="Cental jets after full selection and cleaning, sorted by pt"),
## ML collections             "cleanJetsFwd"    : NTupleCollection("JetFwd",  jetTypeSusy,  6, help="Forward jets after full selection and cleaning, sorted by pt"),            
## ML collections             "fatJets"         : NTupleCollection("FatJet",  fatJetType,  15, help="AK8 jets, sorted by pt"),
## ML collections             ##------------------------------------------------
## ML collections             "discardedJets"    : NTupleCollection("DiscJet", jetTypeSusy, 15, help="Jets discarted in the jet-lepton cleaning"),
## ML collections             "discardedLeptons" : NTupleCollection("DiscLep", leptonTypeSusyExtra, 8, help="Leptons discarded in the jet-lepton cleaning"),
## ML collections             #"recoveredJets"    : NTupleCollection("RecJet", jetTypeSusy, 15, help="Jets recovered declustering in the jet-lepton cleaning"),
## ML collections             #"recoveredSplitJets" : NTupleCollection("RecSplitJet", jetTypeSusy, 15, help="Jets recovered declustering in the jet-lepton cleaning, split"),
## ML collections             ##------------------------------------------------
## ML collections             "ivf"       : NTupleCollection("SV",     svType, 20, help="SVs from IVF"),
## ML collections             "genBHadrons"  : NTupleCollection("GenBHad", heavyFlavourHadronType, 20, mcOnly=True, help="Gen-level B hadrons"),
## ML collections             "genDHadrons"  : NTupleCollection("GenDHad", heavyFlavourHadronType, 20, mcOnly=True, help="Gen-level D hadrons"),
## ML collections             ##------------------------------------------------
## ML collections             "jetsNonTauIdx" : NTupleCollection("JetNoTauIdx",objectInt, 10, help="index of jets not associated to taus"),
## ML collections             ##------------------------------------------------
## ML collections             "LHE_weights"    : NTupleCollection("LHEweight",  weightsInfoType, 1000, mcOnly=True, help="LHE weight info"),
## ML collections  
## ML collections 
## ML collections })
## EDGE collections OLD susyJZBEdge_globalObjects = susyCore_globalObjects.copy()
## EDGE collections OLD 
## EDGE collections OLD susyJZBEdge_collections = susyMultilepton_collections.copy()
## EDGE collections OLD susyJZBEdge_collections.update({
## EDGE collections OLD 
## EDGE collections OLD 
## EDGE collections OLD         "genleps"         : NTupleCollection("genLep",     genParticleWithLinksType, 10, help="Generated leptons (e/mu) from W/Z decays"),                                             
## EDGE collections OLD         #"selectedLeptons" : NTupleCollection("lep", leptonTypeSusy, 50, help="Leptons after the preselection", filter=lambda l : l.pt()>10 ),
## EDGE collections OLD         "cleanJetsAll"         : NTupleCollection("jet", jetTypeSusy, 100, help="all jets (w/ x-cleaning, w/ ID applied w/o PUID applied pt>10 |eta|<5.2) , sorted by pt", filter=lambda l : l.pt()>10  ),
## EDGE collections OLD         "cleanJetsAll_jecUp"   : NTupleCollection("jet_jecUp"  , jetTypeSusy, 100, help="all jets (w/ x-cleaning, w/ ID applied w/o PUID applied pt>10 |eta|<5.2) , sorted by pt JEC UP"  , filter=lambda l : l.pt()>10  ),
## EDGE collections OLD         "cleanJetsAll_jecDown" : NTupleCollection("jet_jecDown", jetTypeSusy, 100, help="all jets (w/ x-cleaning, w/ ID applied w/o PUID applied pt>10 |eta|<5.2) , sorted by pt JEC DOWN", filter=lambda l : l.pt()>10  ),
## EDGE collections OLD         "selectedPhotons"      : NTupleCollection("gamma", photonTypeSusy, 50, help="photons with pt>20 and loose cut based ID"),
## EDGE collections OLD         "generatorSummary"     : NTupleCollection("GenPart", genParticleWithLinksType, 100 , help="Hard scattering particles, with ancestry and links"),
## EDGE collections OLD 
## EDGE collections OLD })
...
susyJZBEdge_collections.update({
            ...
            "cleanJets_jecUp"   : NTupleCollection("Jet_jecUp"  ,jetTypeSusyExtra, 15, help="Cental jets after full selection and cleaning, sorted by pt JEC UP"),
            "cleanJets_jecDown" : NTupleCollection("Jet_jecDown",jetTypeSusyExtra, 15, help="Cental jets after full selection and cleaning, sorted by pt JEC DOWN"),
